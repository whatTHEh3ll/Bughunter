...
echo "Installed ffuf"
GO111MODULE=auto /home/$USER/.go/bin/go -u -v github.com/projectdiscovery/httpx/cmd/httpx
echo "Installed httpx"
GO111MODULE=on /home/$USER/.go get -u -v github.com/projectdiscovery/nuclei/v2/cmd/nuclei
